...
const TaskAssignmentForm: React.FC<TaskAssignmentFormProps> = ({
  ...
  const handleSubmit = () => {
    ...
    if (isNaN(dateObj.getTime())) {
      alert('Invalid date. Please enter a valid due date.');
      return;
    }
    
    const formattedDueDate = dateObj.toISOString();
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Create New Task for Project {projectId}</DialogTitle>
      <DialogContent>
        <TextField
          label="Task Name"
          fullWidth
